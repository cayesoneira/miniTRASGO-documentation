- When the HV is turned off, the gas flux drastically changes for some minutes: this is due to the fact that the HV bends the RPCs so turning it off will make the structure to recover its original shape.
